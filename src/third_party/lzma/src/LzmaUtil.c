...
#include "7zC/LzmaDec.h"
#include "7zC/LzmaEnc.h"
...
// static int Extract(JNIEnv * env, jclass thiz, jstring jsrc, jstring jdest) {
...
//         { "nativeExtract", "(Ljava/lang/String;Ljava/lang/String;IIII)I",
//                 (void*) Extract },
// };
...
//     int ret = JNI_FALSE;
//     ret = registerNativeMethods(env, "com/samtech/SevenZipUtils",
